...
void TMVARegression( TString myMethodList = "" )
{
   ...
   */
   ...
   TFile *input(0);
   TString fname = "TrainingSamples/out_E0to3000Eta1p7_converted.root";
   ...
   */
   ...
   dataloader->PrepareTrainingAndTestTree(mycut,
                                         "nTrain_Regression=1400000:nTest_Regression=400000:SplitMode=Random:NormMode=NumEvents:!V" );
   //
   //     dataloader->PrepareTrainingAndTestTree( mycut,
